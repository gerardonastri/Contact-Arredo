...
const project = {
  ...
  description: "This stunning contemporary villa showcases the perfect blend of minimalist design and luxurious living. Our team transformed a dated structure into a sleek, modern home that embraces clean lines, natural materials, and an open concept layout.",
  images: {
  ...
  reviews: [
    { id: 1, author: "Emma S.", rating: 5, text: "Absolutely blown away by the transformation! The attention to detail is impeccable." },
    { id: 2, author: "Michael L.", rating: 5, text: "The team's vision and execution were flawless. Our dream home became a reality." }
  ]
}
          ...
          {Object.entries(project.images).map(([stage, src]) => (
            <div key={stage} className="relative aspect-[4/3]">
              ...
              <div className="absolute bottom-4 left-4 bg-black bg-opacity-70 px-3 py-1 rounded">
                <span className="text-sm font-light capitalize text-white">{stage}</span>
              </div>
            </div>
          ))}
        </motion.div>
